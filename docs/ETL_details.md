...
![Import do CSV](../images/01_import_csv.png)
...
![Abrir Power Query](../images/02_transform_data.png)
![Abrindo Power Query](../images/03_power_query_init.png)

4. Retirar a etapa de alteração dos tipos de dados no Power Query, na aba de Etapas.
![Remover Alteração de tipo de dados](../images/04_power_query_remove_data_type.png)
...
![Mudando tipo de dados](../images/05_power_query_edit_data_type.png)
...
![Criando colunas](../images/09_pq_add_new_columns.png)
![Criando colunas](../images/10_pq_add_new_columns.png)


## Carregamento (Load) e Validação:
10. Carregamento dos dados tratados para o Excel mediante **Página Inicial > Fechar e Carregar**
![Fechando e Carregando](../images/11_pq_close_load.png)
![Dados carregados](../images/12_data_loaded.png)
...
![Contagem Vazios](../images/13_count_values.png)
![Contagem Vazios](../images/14_count_values.png)
...
![Coluna Nome do Mês](../images/15_month_names.png)
